...
# 331 is the id for NFL season 2014, each year have to update that from
...
class MainWindow(QtGui.QMainWindow):
    ...
    def about(self):
        QtGui.QMessageBox.about(self, 'About Fantasy Football Draft',
                ...
                +'Copyright (C) 2007-2014 Aaron Brice (aaron.brice@gmail.com) \n\n'
...
class MainWidget(QtGui.QWidget):
    ...
    def setup_player_ui(self):
        ...
        statistics_label = QtGui.QLabel('2013 Statistics', widget)
